...
<center>
  ...
  <?php
    ...
    $query1 = "select TIimestamp from cycle where ID='$cycleid' AND status=1";
    ...
    if(isset($_POST['btn'])){
      $locn = $_POST['pk'];
      $que = "UPDATE cycle set   status = 0, TIimestamp = default,Location='$locn',MinsRun='$mins'  WHERE ID ='$cycleid' and status=1 ";
    ...
    mysqli_query($conn, $que);
    $que = "UPDATE registercycle set   Lastlocn = '$locn'	,Lastcust='$reg' WHERE cycleid ='$cycleid'  ";
    mysqli_query($conn, $que);
